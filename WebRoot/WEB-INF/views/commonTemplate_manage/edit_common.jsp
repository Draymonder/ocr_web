...
<script type="text/javascript"
	src="<c:url value="../resources/js/CommonTemplate/editTemplate.js"/>"></script>
</head>
<body>
...
<div class="coupon_contain">
    <div class="coupon_crumbs"><a href="<c:url value="/login/main"/>"><span class="coupon_index">首页</span></a> > <a href="<c:url value="/CommonTemplateManage/showCommonTemplateManage?pageNum=${pageNum}"/>"><span class="cur">自定义模版</span></a> > <span class="cur1">编辑模板</span></div>
    ...
    <div class="quanxian_line"></div>
        <div class="quanxian_box">
            ...
            <div class="quanxian_btn">
                <a href="${path}/CommonTemplateManage/showCommonTemplateManage?pageNum=${pageNum}"><div class="quanxian_quxiao">取　消</div></a>
