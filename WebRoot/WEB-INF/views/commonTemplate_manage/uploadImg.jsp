    ...
    <script>
        $(function () {
            ...
            $(".dataupload_sure").click(function () {
                var f = document.getElementById("upload").files;
                if(f[0].type != "image/jpeg" && f[0].type != "image/png" && f[0].type != "image/tiff"){
                    showDialog1("请上传jpg,png,tif格式图片!")
                    return;
                }
                if(undefined==f[0]){
...
<div class="coupon_contain">
    ...
    </a>><span class="cur">数字化建模管理</span>

    </div>
    <form action="${path}/CommonTemplateManage/Create"  id="from" method="post" enctype="multipart/form-data">
