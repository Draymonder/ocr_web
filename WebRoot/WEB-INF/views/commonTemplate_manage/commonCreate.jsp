...
<head>
    ...
    <script type="text/javascript"
            src="<c:url value="../resources/js/CommonTemplate/templateCreate.js"/>"></script>
    <script type="text/javascript"
...
<div class="coupon_contain">
    <div class="coupon_crumbs">
        ...
        </a> ><a href="${path}/CommonTemplateManage/showCommonTemplateManage?pageNum=1">
        ...
        <div class="data_ctrl_C">
            <div class="data_ctrl_C_lf">
                ...
                <div class="data_ctrl_C_lf_page">
                        <div class="page_num choose_page" >1</div>
                </div>

                <div class="data_ctrl_C_lf_img"  ondrop="drop(event)" ondragover="allowDrop(event)">
                    <img  ondragstart="dragStart(event)" ondrag="drag(event)" ondragend="dragEnd(event)" draggable="true" id="dragtarget" width="100%" src="${jpgSrc}"/>
            ...
            <div class="data_ctrl_C_rg">
                ...
                <div class="data_ctrl_C_rg_select">
                    <div class="data_ctrl_C_rg_select_title">
                        <div id="title_div1">请选择字体库</div>
                        <div id="jt1"></div>
                        <div class="clear"></div>
                    </div>
                    <div class="data_ctrl_C_rg_select_list">
                        <c:forEach var="traineddataName" items="${trainList}">
                            <div class="data_ctrl_C_rg_select_li2" data-id="${traineddataName.id}" data-name="${traineddataName.traineddata}">
                                <div>${traineddataName.traineddata}</div>
                            </div>
                        </c:forEach>
                    </div>
                </div>
                <div class="data_ctrl_C_rg_select">
                    ...
                    <div class="data_ctrl_C_rg_select_list">
                        <c:forEach var="fieldName" items="${nameList}">
                            <div class="data_ctrl_C_rg_select_li" data-id="${fieldName}" data-name="${fieldName}">
                                <div>${fieldName}</div>
                            </div>
                        </c:forEach>
                    </div>
                ...
                <div class="data_ctrl_C_rg_input">
                    ...
                    <div class="data_ctrl_C_rg_input_2">
                        <input type="text" name="" id="note" value="" placeholder=""  />
                    </div>
                </div>
                <div class="data_ctrl_C_rg_input">
                    <div class="data_ctrl_C_rg_input_1">
