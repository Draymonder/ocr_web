...
<script type="text/javascript"
	src="<c:url value="../resources/js/CommonTemplateSearch/Edit.js"/>"></script>
	<style type="text/css">
		.pop_mouseover_img{
			position: absolute;
			display: none;
...
<body>
	<script>
		$(function () {
            ...
            var suffix1;
            if((suffix == "PNG") || (suffix=="png")) suffix1 = ".png";
            else if((suffix == "tif") || (suffix=="TIF")) suffix1 = ".tif";
            else suffix1 = ".jpg";
...
<a href="<c:url value="/login/main"/>"><span class="coupon_index">首页</span>
    </a> > <a href="${path}/CommonTemplateSearchManage/showCommonTemplateSearchManage?pageNum=${pageNum}"><span
