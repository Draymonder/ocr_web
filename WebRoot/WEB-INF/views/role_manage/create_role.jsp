...
<script type="text/javascript"
	src="<c:url value="../resources/js/roles/createUser.js"/>"></script>
</head>
<body>
...
<div class="coupon_contain">
    <div class="coupon_crumbs">
        <a href="<c:url value="/login/main"/>"><span 
            ...
            class="cur">角色管理</span></a> > <span class="cur1">新建角色</span>
    </div>
                ...
                <div class="quanxian_table">
                    <table width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td class="quanxian_tianjia">
                                <input type="text" class="quanxian_long" value="" id="roleName"/>
                            </td>
                        </tr>
                        <tr>
