...
<script type="text/javascript"
	src="<c:url value="../resources/js/roles/editUser.js"/>"></script>
</head>
<body>
...
<div class="coupon_contain">
    <div class="coupon_crumbs"><a href="<c:url value="/login/main"/>"><span class="coupon_index">首页</span></a> > <a href="<c:url value="/RoleManage/showRoleManage?pageNum=${pageNum}"/>"><span class="cur">角色管理</span></a> > <span class="cur1">编辑角色</span></div>
    ...
    <div class="quanxian_line"></div>
        <div class="quanxian_box">
                    ...
                    <table width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td class="quanxian_tianjia">
                                <div class="quanxian_input jiaose" id="roleId">${roleBean.id}</div>
                            </td>
                        </tr>
                        <%-- 
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="quanxian_tianjia">
                                <input type="text" class="quanxian_long" value="${roleBean.roleName}" id="roleName"/>
                            </td>
                        </tr>
            ...
            <div class="quanxian_btn">
                <a href="${path}/RoleManage/showRoleManage?pageNum=${pageNum}"><div class="quanxian_quxiao">取　消</div></a>
