...
<body>
	...
	<div class="coupon_contain">
		<div class="coupon_crumbs">
			...
			</a> > <a href="<c:url value="/RoleManage/showRoleManage?pageNum=${pageNum}"/>"><span class="cur">角色管理</span></a> > <span class="cur1">角色详情</span>
		</div>
			...
			<div class="quanxian_info">
				<div class="quanxian_table">
					<table width="100%" border="0">
						...
						<tr>
							<td class="quanxian_name">角色名称:</td>
							<td class="quanxian_tianjia">
								<div class="quanxian_input">${roleBean.roleName}</div></td>
						</tr>
						<tr>
							<td class="quanxian_name">角色编号:</td>
							<td class="quanxian_tianjia">
								<div class="quanxian_input">${roleBean.roleNumber}</div></td>
						</tr>
						<%-- 
						<tr>
						...
						<tr>
							<td class="quanxian_name">所属地市:</td>
							<td class="quanxian_tianjia">
								<div class="quanxian_input">${userBean.fCity}</div></td>
						</tr>
