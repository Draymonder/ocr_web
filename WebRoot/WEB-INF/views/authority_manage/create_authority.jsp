...
<script type="text/javascript"
	src="<c:url value="../resources/js/authority/createUser.js"/>"></script>
</head>
<body>
...
<div class="coupon_contain">
    <div class="coupon_crumbs">
        <a href="<c:url value="/login/main"/>"><span 
            ...
            href="<c:url value="/authorityManage/showAuthorityManage?pageNum=${pageNum}"/>"><span 
            class="cur">权限管理</span></a> > <span class="cur1">新建权限</span>
    </div>
            ...
            <div class="quanxian_info">
                <div class="quanxian_table">
                    <table width="100%" border="0">
                        ...
                        --%>
                        <tr>
                            <td class="quanxian_name"><span style="color: red;">*</span>权限名称:</td>
                            <td class="quanxian_tianjia">
                                <input type="text" class="quanxian_long" value="" id="authName"/>
                            </td>
                        </tr>
                        <%--
                        <tr>
