...
<script type="text/javascript"
	src="<c:url value="../resources/js/authority/editUser.js"/>"></script>
</head>
<body>
...
<div class="coupon_contain">
    <div class="coupon_crumbs"><a href="<c:url value="/login/main"/>"><span class="coupon_index">首页</span></a> > <a href="<c:url value="/authorityManage/showAuthorityManage?pageNum=${pageNum}"/>"><span class="cur">权限管理</span></a> > <span class="cur1">编辑权限</span></div>
    ...
    <div class="quanxian_line"></div>
        <div class="quanxian_box">
            <div class="quanxian_info">
                <div class="quanxian_table">
                    <table width="100%" border="0">
                        <c:forEach items="${Authlist}" var="authBean" varStatus="order">
                        <tr>
                            <td class="quanxian_name"><span style="color: red;">*</span>ID:</td>
                            <td class="quanxian_tianjia">
                                <div class="quanxian_input jiaose" id="authId">${authBean.id}</div>
                            </td>
                        </tr>
                        <%-- 
                        <tr>
                        ...
                        --%>
                        <tr>
                            <td class="quanxian_name"><span style="color: red;">*</span>角色名称:</td>
                            <td class="quanxian_tianjia">
                                <input type="text" class="quanxian_long" value="${authBean.name}" id="authName"/>
                            </td>
                        </tr>
                        </c:forEach>
                        <%-- 
            ...
            <div class="quanxian_btn">
                <a href="${path}/authorityManage/showAuthorityManage?pageNum=${pageNum}"><div class="quanxian_quxiao">取　消</div></a>
