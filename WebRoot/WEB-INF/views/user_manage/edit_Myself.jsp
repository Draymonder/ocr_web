...
<script type="text/javascript"
	src="<c:url value="../resources/js/users/editMyself.js"/>"></script>
...
<div class="coupon_contain">
    <div class="coupon_crumbs"><a href="<c:url value="/login/main"/>"><span class="coupon_index">首页</span></a> > <a href="<c:url value="/userManage/showEditMyself?fAccountNumber=${user.fAccountNumber}&pageNum=1"/>"><span class="cur">个人信息修改</span></a> </div>
