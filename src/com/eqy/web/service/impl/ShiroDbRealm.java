...
import com.eqy.web.service.authority.imp.*;
...
public class ShiroDbRealm extends AuthorizingRealm
{
    ...
    @Autowired
    protected TNgcAuthorityMapper  TNgcAuthorityMapper;
    /**
     * 认证回调函数,登录时调用.
     */
    @Override
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals)
    {
      ...
      final List<TNgcAuthority> TNgcAuthority= TNgcAuthorityMapper.selectAuthorityByAccount(user.getfAccountNumber()); 
        for (TNgcAuthority t : TNgcAuthority)
        {
          System.out.println(t.getPermission());
          info.addStringPermission(t.getPermission());
