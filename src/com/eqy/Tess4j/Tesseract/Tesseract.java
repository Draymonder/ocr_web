...
import com.eqy.Tess4j.util.ImageIOHelper;
import com.eqy.Tess4j.util.LoggHelper;
import com.eqy.Tess4j.util.PdfUtilities;
...
public class Tesseract implements ITesseract {
     ...
     * @throws TesseractException
     */
    private void createDocuments(String filename, ITessAPI.TessResultRenderer renderer) throws TesseractException {
    ...
    public List<Rectangle> getSegmentedRegions(BufferedImage bi, int pageIteratorLevel) throws TesseractException {
        ...
        try {
            ...
            Boxa boxes = api.TessBaseAPIGetComponentImages(handle, pageIteratorLevel, ITessAPI.TRUE, null, null);
    ...
    public List<Word> getWords(BufferedImage bi, int pageIteratorLevel) {
        ...
        try {
            ...
            ITessAPI.TessPageIterator pi = api.TessResultIteratorGetPageIterator(ri);
            ...
            do {
                ...
                words.add(word);
            } while (api.TessPageIteratorNext(pi, pageIteratorLevel) == ITessAPI.TRUE);
